...
jpackage --runtime-image target/jlink-image/ --module hellofx/ortwin.Main --dest target/deb
#sudo apt install ./target/deb/main_1.0-1_amd64.deb
#cd /opt/main/bin || exit
#./Main
